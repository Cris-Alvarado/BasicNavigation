...
import com.example.basicnavigation.databasepokemon.Metodo
import com.example.basicnavigation.databasepokemon.Pokemon
import com.example.basicnavigation.databinding.ItemUserBinding

class PokedexAdapter (private val pokemon : List<Pokemon>,  private val callBack: Metodo): RecyclerView.Adapter<PokedexAdapter.PokemonHolder>() {
    ...
    class PokemonHolder(val binding: ItemUserBinding,val callBack: Metodo) : RecyclerView.ViewHolder(binding.root){
